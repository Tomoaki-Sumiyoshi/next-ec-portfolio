...
export const CreateOrderRequest = z.object({
  userId: z.string(),
  itemList: z.array(OrderItem),
  customer: OrderCustomer,
  shippingAddress: OrderAddress,
});

export type Order = z.infer<typeof Order>;
export const Order = z.intersection(
  CreateOrderRequest,
  z.object({
    id: z.string(),
    createdAt: z.string(),
...
export type get_ListOrders = typeof get_ListOrders;
export const get_ListOrders = {
  method: z.literal('GET'),
...
export type post_CreateOrder = typeof post_CreateOrder;
export const post_CreateOrder = {
